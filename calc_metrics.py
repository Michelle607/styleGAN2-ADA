...
@click.command()
@click.pass_context
@click.option('network_pkl', '--network', help='Network pickle filename or URL', metavar='PATH', required=True, default="E:/downloads/PycharmProjects_E/stylegan2-ada-pytorch/~/training-runs/00009-A-auto1-kimg10000-batch4/network-snapshot-000200.pkl")
@click.option('--metrics', help='Comma-separated list or "none"', type=CommaSeparatedList(), default='fid50k_full', show_default=True)
@click.option('--data', help='Dataset to evaluate metrics against (directory or zip) [default: same as training data]', metavar='PATH', default="E:/downloads/PycharmProjects_E/stylegan2-ada-pytorch/data/A")
