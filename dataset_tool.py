...
@click.command()
@click.pass_context
@click.option('--source', help='Directory or archive name for input dataset', required=True, default='E:/downloads/PycharmProjects_E/stylegan2-ada-pytorch/data/A')
@click.option('--dest', help='Output directory or archive name for output dataset', required=True, default="E:/downloads/PycharmProjects_E/stylegan2-ada-pytorch/data/B")
...
@click.option('--width', help='Output width', type=int, default=256)
@click.option('--height', help='Output height', type=int, default=256)
def convert_dataset(
    ctx: click.Context,
    source: str,
    dest: str,
